		 ...
		 switch(number) {
		    ...
		    case 14:
		 	...
		 	case 15:
			 	...
			 	break;
		 	case 16:
		 		System.out.println("euro tor rupee:");
		 		rupee=amount*80;
		 		System.out.println(f.format(rupee));
		 		break;
		 	case 17:
		 		System.out.println("euro tor pound:");
		 		pound=amount*0.90;
		 		System.out.println(f.format(pound));
		 		break;
		 	case 18:
		 		System.out.println("euro tor yen:");
		 		yen=amount*127.32;
		 		System.out.println(f.format(yen));
		 		break;
		 	case 19:
		 		System.out.println("euro tor dollar:");
		 		dollar=amount*1.14;
		 		System.out.println(f.format(dollar));
		 		break;
		 	case 20:
		 		System.out.println("euro tor ringgit:");
		 		ringgit=amount*4.78;
		 		System.out.println(f.format(ringgit));
		 		break;
		 	case 21:
		 		System.out.println("yen tor rupee:");
		 		rupee=amount*0.63;
		 		System.out.println(f.format(rupee));
		 		break;
		 	case 22:
		 		System.out.println("yen tor euro:");
		 		euro=amount*0.007;
		 		System.out.println(f.format(euro));
		 		break;
		 	case 23:
		 		System.out.println("yen tor dollar:");
		 		dollar=amount*0.008;
		 		System.out.println(f.format(dollar));
		 		break;
		 	case 24:
		 	...
		 	case 26:
		 		...
		 		break;
		 	case 27:
		 		System.out.println("ringgit tor euro:");
		 		euro=amount*0.209;
		 		System.out.println(f.format(euro));
		 		break;
		 	case 28:
		 		System.out.println("ringgit tor dollar:");
		 		dollar=amount*0.239;
		 		System.out.println(f.format(dollar));
		 		break;
		 		case 29:
